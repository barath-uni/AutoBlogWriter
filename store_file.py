...
def write_links_to_file(list_of_links, file_name):
  ...
  "<div class='container px-5 py-24 mx-auto border-a-8'>"\
    "<div class='mx-auto flex flex-wrap' id='ig8o'>"\
      ...
      "<div class='lg:w-1/2 lg:pl-10 lg:py-6 mt-6 lg:mt-0'>"\
        ...
        "<form method='get' id='ixww' class='p-2>"\
          ...
          "<div class='flex'>"\
            f"<button type='submit' class='flex ml-auto text-white bg-indigo-500 border-0 p-2 focus:outline-none hover:bg-indigo-600 rounded'><a href=\"{dictionary['link']}\"> Amazon</a></button>"\
          "</div>"\
        "</form>"\
      "</div>"\
    "</div>"\
